...
|---|---|---|---|---|
| e2e/tests/auth.spec.ts | 6 | Migrate to tests/regression/auth-login.spec.ts + auth-session.spec.ts; health/root cases become route smoke | Phase 2 | migrating (Phase 2) |
